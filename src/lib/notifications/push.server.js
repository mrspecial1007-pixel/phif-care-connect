...
if (publicVapidKey && privateVapidKey) {
    webpush.setVapidDetails('mailto:support@phif-tracker.lovable.app', publicVapidKey, privateVapidKey);
}
export async function pushNotification(subscription, payload) {
    if (!privateVapidKey) {
