-- Update v_patient_status to include track status in the JSON aggregation
...
CREATE OR REPLACE VIEW public.v_patient_status AS
 ...
 SELECT p.id AS patient_id,
    ...
    CASE 
      WHEN ts.has_partial_track OR ts.active_tracks_count > 1 THEN 'Partial'::text
